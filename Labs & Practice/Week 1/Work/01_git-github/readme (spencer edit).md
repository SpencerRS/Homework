...
* How do I send changes to the staging area?
	...
	git add in CLI, check boxes in GUI
* How do I check what is going to be committed?

	look at the check boxes in GUI or git diff in CLI
* How do I send the commits to GitHub?

	git push in CLI or press commit button in GUI
...
* How does github know that I am allowed to push to a specific repo?
	it checks your account against a list of accounts with permission?
